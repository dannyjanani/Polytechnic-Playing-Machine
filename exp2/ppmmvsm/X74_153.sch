...
<drawing version="7">
    ...
    <netlist>
        ...
        <signal name="Y1" />
        <signal name="Y2" />
        <port polarity="Input" name="I1C0" />
        <port polarity="Input" name="I1C1" />
        <port polarity="Input" name="I1C2" />
        <port polarity="Input" name="I1C3" />
        <port polarity="Input" name="G1" />
        <port polarity="Input" name="I2C0" />
        <port polarity="Input" name="I2C1" />
        <port polarity="Input" name="I2C2" />
        <port polarity="Input" name="I2C3" />
        ...
        <block symbolname="m2_1" name="XLXI_1">
            <blockpin signalname="I1C0" name="D0" />
            <blockpin signalname="I1C1" name="D1" />
            <blockpin signalname="A" name="S0" />
            <blockpin signalname="XLXN_1" name="O" />
        </block>
        <block symbolname="m2_1" name="XLXI_2">
            <blockpin signalname="I1C2" name="D0" />
            <blockpin signalname="I1C3" name="D1" />
            <blockpin signalname="A" name="S0" />
            <blockpin signalname="XLXN_2" name="O" />
        </block>
        <block symbolname="m2_1" name="XLXI_3">
            <blockpin signalname="I2C0" name="D0" />
            <blockpin signalname="I2C1" name="D1" />
            <blockpin signalname="A" name="S0" />
            <blockpin signalname="XLXN_13" name="O" />
        </block>
        <block symbolname="m2_1" name="XLXI_4">
            <blockpin signalname="I2C2" name="D0" />
            <blockpin signalname="I2C3" name="D1" />
            <blockpin signalname="A" name="S0" />
    ...
    <sheet sheetnum="1" width="3520" height="2720">
        ...
        <branch name="A">
            <wire x2="1360" y1="1792" y2="1792" x1="944" />
        ...
        <iomarker fontsize="28" x="960" y="704" name="I1C0" orien="R180" />
        <iomarker fontsize="28" x="960" y="768" name="I1C1" orien="R180" />
        <iomarker fontsize="28" x="960" y="976" name="I1C2" orien="R180" />
        <iomarker fontsize="28" x="960" y="1040" name="I1C3" orien="R180" />
        <iomarker fontsize="28" x="960" y="1200" name="G1" orien="R180" />
        <iomarker fontsize="28" x="960" y="1360" name="I2C0" orien="R180" />
        <iomarker fontsize="28" x="960" y="1424" name="I2C1" orien="R180" />
        <iomarker fontsize="28" x="960" y="1664" name="I2C2" orien="R180" />
        <iomarker fontsize="28" x="960" y="1728" name="I2C3" orien="R180" />
        <iomarker fontsize="28" x="944" y="1792" name="A" orien="R180" />
        <iomarker fontsize="28" x="960" y="1872" name="B" orien="R180" />
        <iomarker fontsize="28" x="960" y="1952" name="G2" orien="R180" />
